...
export default async function FaqsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-lg font-semibold text-slate-900">Sıkça Sorulan Sorular</h1>
        <p className="text-sm text-slate-500">
          Sıra numarası küçük olan önce gösterilir.
        </p>
      </div>

      <form action={createFaq} className="space-y-3 rounded-lg border border-slate-200 bg-white p-4">
        <h2 className="text-sm font-medium text-slate-700">Yeni soru</h2>
        <input
          name="question"
          placeholder="Soru"
          required
      ...
      <div className="space-y-3">
        {items.length === 0 && <p className="text-sm text-slate-400">Henüz soru yok.</p>}
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button
                  formAction={deleteFaq.bind(null, item.id)}
