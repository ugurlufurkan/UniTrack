 ...
 * bozmadan.
 *
 * Kullanım, orijinal `Button`/`TextButton` ile birebir aynı. Uygulama genelinde
 * (dialoglar, formlar, snackbar aksiyonları) düz `Button`/`TextButton` yerine
 * bunlar kullanılmalı — tutarlı "premium" his için tüm ekranlar bu ikisini
 * kullanmalı.
 */
@Composable
fun PremiumButton(
